defmodule GenswarmWeb.SwarmChannel do
  @moduledoc """
  ...
  def handle_in("subscribe_logs", payload, socket) do
    ...
    Phoenix.PubSub.subscribe(Genswarm.PubSub, topic)
  ...
  def handle_in("unsubscribe_logs", payload, socket) do
    ...
    Phoenix.PubSub.unsubscribe(Genswarm.PubSub, topic)
