defmodule Genswarm.Observability.TelemetryBridge do
  @moduledoc """
  ...
  every meaningful state transition (`[:genswarm, :swarm|:agent|:object|:router,
  ...
  @handler_id "genswarm-telemetry-bridge"

  @doc """
  Attaches the bridge handler to every `[:genswarm, <domain>, <event>]` telemetry
  ...
  # the concrete `[:genswarm, domain, event]` triples so unrelated `:genswarm`
